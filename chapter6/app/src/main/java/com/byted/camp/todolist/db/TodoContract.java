...
public final class TodoContract {
    ...
    public static final String STARTUPS_NAME = "startups";
    public static final String STARTUPS_COUNT = "count";

    public static final String SQL_CREATE_STARTUPS =
            "CREATE TABLE " + STARTUPS_NAME + "(" + STARTUPS_COUNT + " INTEGER)";
